...
const Communication = props =>
  <div className="auth">
    <div className="media-controls">
      <Link className="call-exit-button" href="/">
    ...
    <div className="room-occupied">
      ...
      <Link  className="primary-button" href="/">OK</Link>
    </div>
    <div className="waiting">
      <p><span>Waiting for someone to join this room:&nbsp;</span><a href={checkWindow()}>{checkWindow()}</a><br/>
